...
cyd::Transform::Transform( const glm::vec3& origin ) : pos( origin ) {}

glm::mat4 cyd::Transform::getModelMatrix() const
{
...
void cyd::Transform::translateLocal( float x, float y, float z )
{
   glm::vec3 delta = glm::rotate( rotation, glm::vec3( x, y, z ) );
   translate( delta );
}

void cyd::Transform::translateLocal( const glm::vec3 translation )
{
   glm::vec3 delta = glm::rotate( rotation, translation );
   translate( delta );
}

void cyd::Transform::rotate( float pitch, float yaw, float roll )
{
...
void cyd::Transform::rotateLocal( float pitch, float yaw, float roll )
{
...
void cyd::Transform::scale( const glm::vec3& scale ) { scaling *= scale; }
